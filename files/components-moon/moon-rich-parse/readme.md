## moon-rich-parse 适用于 uni-app/mpvue 的富文本解析组件
...
<template>
  <div>
    <moon-rich-parse :content="article" @preview="preview" @navigate="navigate" />
  </div>
</template>
...
<style>
@import url("@/components-moon/moon-rich-parse/u-parse.css");
</style>
```
